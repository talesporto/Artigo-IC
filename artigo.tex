...
As análises serão feitas a partir de um ponto de vista apocalíptico, conforme os conceitos da mídia de massa apresentados por Umberto Eco~\cite{eco}, com os quais é possível criticar a manipulação da informação modificando a cultura de massa (1).

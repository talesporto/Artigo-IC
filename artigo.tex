...
Apesar da denconfiança gerada nesse tipo de mídia a massa que quer consumir esse tipo de informação não se questiona sobre a veracidade das informações e acredita ``cegamente'' na informação que lhe foi entregue.
